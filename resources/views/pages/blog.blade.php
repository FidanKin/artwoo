...
<head>
    ...
    <title>Страница просмотра записи блога, события или конкурса</title>
    <!-- Fonts -->
...
<x-layout.standard bgGray={{ true }}>
    <x-layout.secondary.content-base title="Просмотр одной записи" isViewSingleItem="{{ true }}"
                                     canManage="{{ true }}">
        <x-widgets.blog-view-item />
