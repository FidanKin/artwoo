<div id="{{ $id }}" class="flex items-center p-4 mb-4 rounded-lg {{ $messageColors }}" role="alert">
    ...
    <button type="button" class="ms-auto -mx-1.5 -my-1.5 rounded-lg
        focus:ring-2 p-1.5 inline-flex items-center justify-center h-8 w-8 text-red-500 focus:ring-red-400
        hover:bg-red-200"
